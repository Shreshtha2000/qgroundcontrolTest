...
Item {
    ...
    property bool   _showGrid:          QGroundControl.settingsManager.videoSettingsList[0].gridLines.rawValue > 0
    ...
    property int    _fitMode:           QGroundControl.settingsManager.videoSettingsList[0].videoFit.rawValue
    property int    _videoNum:          0
    ...
    property double _thermalHeightFactor: 0.85 //-- TODO
        ...
        Image {
            ...
            QGCLabel {
                id:                 noVideoLabel
                text:               QGroundControl.settingsManager.videoSettingsList[0].streamEnabled.rawValue ? qsTr("WAITING FOR VIDEO") : qsTr("VIDEO DISABLED")
    ...
    Rectangle {
        ...
        Loader {
            ...
            anchors.centerIn:   parent
            visible:           /* QGroundControl.videoManager.decoding*/_videoNum == 0
            sourceComponent:    videoBackgroundComponent1

            property bool videoDisabled: QGroundControl.settingsManager.videoSettingsList[0].videoSource.rawValue === QGroundControl.settingsManager.videoSettings.disabledVideoSource
        }
